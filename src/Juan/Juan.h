...
namespace Juan {
  ...
  std::vector<Point_2> generateRandomPoints(int n , Juan::Ellipse e);
  bool comparator( Point_2 a , Point_2 b );
  bool reverseComparator( Point_2 a , Point_2 b );
  Cloud sortByX( Cloud dots );
  Cloud reverseSortByX( Cloud dots );
} /* Juan */
